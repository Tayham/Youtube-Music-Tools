...
from core.constants.menu import (ADD_SKIP_LIST_OPTION, MENU_SONG_COMPARE_PROMPT,
                                 PLAYLIST_CHOICE_TITLE, QUIT_OPTION, REMOVE_RATED_SONGS_FROM_DEFAULT_PLAYLISTS_OPTION, REMOVE_RATED_SONGS_FROM_PLAYLIST_OPTION, REPLACE_UPLOADED_SONGS_WITH_STREAMING_VERSIONS, SEARCH_RESULT_TITLE,
                                 SELECTION_MADE_TITLE, SKIP_OPTION)
from core.constants.printout import (ADDING, FAILURE, LIBRARY, PLAYLIST, RETRY, SONG,
                                     STREAMING, UPLOADED)
...
def remove_rated_songs_from_default_playlists_selection() -> None:
    ...
    remove_rated_songs_playlists = get_matching_playlists_from_playlist_title_list(get_library_playlists(), 
        youtube_music_tools_settings.get_default_remove_rated_songs_playlist_titles())
...
def remove_rated_songs_from_playlist_selection() -> None:
    ...
    selected_playlist = list_selection_menu(PLAYLIST_CHOICE_TITLE, get_library_playlists(), allow_quit=True).get(PLAYLIST_CHOICE_TITLE)
